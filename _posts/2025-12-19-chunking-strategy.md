---
layout: post
title: "The Chunking Strategy: How to Listen to Research Without Losing the Thread"
date: 2025-12-19
author: "Eric Tate"
...
- concepts introduced, then referenced 10 paragraphs later
- detail that matters only if you already know what you’re looking for
- a structure that assumes you’ll skim, jump, and re-read
...
Examples:
- “What’s the main claim here?”
- “What’s the evidence?”
- “What changed compared to last year?”
- “What are the risks and assumptions?”
- “What would I do differently if this is true?”
...
Instead:
- For the important chunk, listen again at 0.9× while lightly following the text visually.
- Capture specifics: numbers, names, dates, conditions (“only when…”, “except when…”).
- If it’s not important enough for a second pass, it’s not important enough to obsess over.
...
- reference lists
- long citation clusters
- raw tables (without interpretation)
- repeated headers/footers
- footnotes that break every sentence
...
Example:
- “Table 2 shows costs spike in Q3 and flatten afterward.”
...
- Listen for one claim at a time.
- After each chunk, ask: “What is this based on?”
- If the chunk can’t answer that, it goes into a “verify” pile.
...
Thread log:
- Chunk 1: The point is…
- Chunk 2: The point is…
- Chunk 3: The point is…

Parking lot (verify later):
- Claim to check: …
- Number/source missing: …
- Term unclear: …
...
☐ The chunk is small enough to summarize in one sentence
☐ I removed obvious junk (headers, footers, navigation)
☐ I’m not pasting raw tables or reference lists
